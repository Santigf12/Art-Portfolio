...
export interface ApiSelectedWorkSelectedWork
  extends Struct.CollectionTypeSchema {
  collectionName: 'selected_works';
  info: {
    displayName: 'selected-work';
    pluralName: 'selected-works';
    singularName: 'selected-work';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::selected-work.selected-work'
    >;
    order: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::selected-work.selected-work': ApiSelectedWorkSelectedWork;
